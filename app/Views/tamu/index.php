                ...
                <table class="table align-items-center mb-0 border rounded">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Nama</th>
                            <th class="text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Alamat </th>
                            <th class="text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Telepon</th>
