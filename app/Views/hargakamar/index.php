                ...
                <table class="table align-items-center mb-0 border rounded">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Jenis Kamar</th>
                            <th class="text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Harga Kamar </th>
                            <th class="text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Rincian</th>
                    ...
                    <tbody>
                        ...
                        foreach ($dataHargakamar as $dt) : ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $dt["jenis_kamar"] ?></td>
                                <td><?= rupiah($dt["harga_kamar"]) ?></td>
                                <td><?= $dt["rincian"] ?></td>
